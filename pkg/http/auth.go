...
// WithRetryableClient attaches a AuthReqContextFunc to the AuthClient.
...
// provided the DefaultAuthPolicy will be used. If no AuthReqCtxFunc
// is provided the DefaultAuthReqContext is used.
